...
jeff.kelley@blackboard.com - 2026-06-24
   ============================================================ */
...
-- select viewer_name, viewer_email, count(distinct container_id) as active_course_count, count(distinct media_id) as active_media_count, sum(view_count) as total_views, sum(minutes_viewed) as total_minutes, max(pc_viewed) as max_pc_viewed from video_usage group by all order by total_views desc limit 25;/* Explore Video Studio Usage through CDM_MEDIA */
